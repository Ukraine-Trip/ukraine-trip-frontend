...
const destinationsData = [
  ...
  { region: 'ДНІПРОПЕТРОВСЬКА ОБЛАСТЬ', cities: ['Дніпро', 'Кривий Ріг', "Кам'янське"] },
  { region: 'ДОНЕЦЬКА ОБЛАСТЬ', cities: ['Донецьк', 'Маріуполь', 'Краматорськ'] },
  { region: 'ЖИТОМИРСЬКА ОБЛАСТЬ', cities: ['Житомир', 'Бердичів', 'Коростень'] },
  { region: 'ЗАКАРПАТСЬКА ОБЛАСТЬ', cities: ['Ужгород', 'Мукачево', 'Берегове'] },
  { region: 'ЗАПОРІЗЬКА ОБЛАСТЬ', cities: ['Запоріжжя', 'Мелітополь', 'Бердянськ'] },
  { region: 'ІВАНО-ФРАНКІВСЬКА ОБЛАСТЬ', cities: ['Івано-Франківськ', 'Коломия', 'Яремче'] },
  { region: 'КИЇВСЬКА ОБЛАСТЬ', cities: ['Київ', 'Біла Церква', 'Бровари'] },
  { region: 'КІРОВОГРАДСЬКА ОБЛАСТЬ', cities: ['Кропивницький', 'Олександрія', "Знам'янка"] },
  { region: 'ЛУГАНСЬКА ОБЛАСТЬ', cities: ['Луганськ', 'Сєвєродонецьк', 'Лисичанськ'] },
  { region: 'ЛЬВІВСЬКА ОБЛАСТЬ', cities: ['Львів', 'Трускавець', 'Дрогобич'] },
  { region: 'МИКОЛАЇВСЬКА ОБЛАСТЬ', cities: ['Миколаїв', 'Первомайськ', 'Вознесенськ'] },
  { region: 'ОДЕСЬКА ОБЛАСТЬ', cities: ['Одеса', 'Ізмаїл', 'Чорноморськ'] },
  { region: 'ПОЛТАВСЬКА ОБЛАСТЬ', cities: ['Полтава', 'Кременчук', 'Миргород'] },
  { region: 'РІВНЕНСЬКА ОБЛАСТЬ', cities: ['Рівне', 'Дубно', 'Острог'] },
  { region: 'СУМСЬКА ОБЛАСТЬ', cities: ['Суми', 'Конотоп', 'Шостка'] },
  { region: 'ТЕРНОПІЛЬСЬКА ОБЛАСТЬ', cities: ['Тернопіль', 'Чортків', 'Кременець'] },
  { region: 'ХАРКІВСЬКА ОБЛАСТЬ', cities: ['Харків', 'Лозова', 'Ізюм'] },
  { region: 'ХЕРСОНСЬКА ОБЛАСТЬ', cities: ['Херсон', 'Нова Каховка', 'Генічеськ'] },
  { region: 'ХМЕЛЬНИЦЬКА ОБЛАСТЬ', cities: ['Хмельницький', "Кам'янець-Подільський", 'Шепетівка'] },
  { region: 'ЧЕРКАСЬКА ОБЛАСТЬ', cities: ['Черкаси', 'Умань', 'Сміла'] },
  { region: 'ЧЕРНІВЕЦЬКА ОБЛАСТЬ', cities: ['Чернівці', 'Хотин', 'Сторожинець'] },
...
export const CreateRoutePage = () => {
  ...
  const activeRegionData = activeRegionIndex !== null ? destinationsData[activeRegionIndex] : null;
  ...
  return (
    ...
    <PageWrapper sx={{ pt: 14, pb: 8 }}>
      ...
      <MenuContainer sx={{ m: 0, ml: { xs: 2, md: 8 }, alignItems: 'flex-start' }}>
